...
assert.match(index, /provider-ux\.css\?v=4/);
assert.match(index, /site-update\.js\?v=4/);
assert.match(index, /provider\.js\?v=4/);
assert.match(index, /class="provider-view mobile-more-overlay" data-provider-panel="more"/);
assert.match(worker, /provider-ux\.css\?v=4/);
assert.match(worker, /site-update\.js\?v=4/);
assert.match(worker, /provider\.js\?v=4/);
assert.match(worker, /manifest\.webmanifest\?v=4/);
assert.match(worker, /provider-feature-assets\.js\?v=4/);
