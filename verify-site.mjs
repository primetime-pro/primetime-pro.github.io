...
assert.match(index, /manifest\.webmanifest\?v=3/);
...
assert.match(index, /provider-ux\.css\?v=3/);
assert.match(index, /site-update\.js\?v=3/);
assert.match(index, /provider\.js\?v=3/);
assert.match(index, /class="provider-view mobile-more-overlay" data-provider-panel="more"/);
assert.match(worker, /provider-ux\.css\?v=3/);
assert.match(worker, /site-update\.js\?v=3/);
assert.match(worker, /provider\.js\?v=3/);
assert.match(worker, /manifest\.webmanifest\?v=3/);
assert.match(worker, /provider-feature-assets\.js\?v=3/);
...
assert.match(read('provider-schedule-minimal.css'), /background:var\(--theme-accent\)!important/);
