...
assert.match(index, /manifest\.webmanifest\?v=6/);
...
assert.match(index, /provider-ux\.css\?v=6/);
assert.match(index, /site-update\.js\?v=6/);
assert.match(index, /provider\.js\?v=6/);
assert.match(index, /provider-schedule-desktop-reference\.css\?v=6[^>]+media="\(min-width: 761px\)"/);
assert.match(index, /class="provider-view mobile-more-overlay" data-provider-panel="more"/);
assert.match(worker, /provider-ux\.css\?v=6/);
assert.match(worker, /site-update\.js\?v=6/);
assert.match(worker, /provider\.js\?v=6/);
assert.match(worker, /manifest\.webmanifest\?v=6/);
assert.match(worker, /provider-feature-assets\.js\?v=6/);
assert.match(worker, /provider-schedule-desktop-reference\.css\?v=6/);
