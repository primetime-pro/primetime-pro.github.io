...
const ASSETS = [
  ...
  './provider-icon-192.png?v=2',
  './provider-icon-512.png?v=2',
  './provider-icon-maskable-512.png?v=2',
  './provider-icon.svg?v=2',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=821',
  ...
  './provider-schedule-minimal.css?v=1',
  ...
  './provider-feature-assets.js?v=2',
];
