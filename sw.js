...
const ASSETS = [
  ...
  './provider-icon-192.png?v=7',
  './provider-icon-512.png?v=7',
  './provider-icon-maskable-512.png?v=7',
  './provider-icon.svg?v=7',
  './icon.svg',
  './ui-icons.svg',
  './styles.css?v=822',
  ...
  './provider-schedule-minimal.css?v=7',
  ...
  './provider-feature-assets.js?v=7',
];

// Warm after the first screen. A cold installation must not wait for tools
// that are only used from a dialog; retain their offline use after warming.
const OPTIONAL_ASSETS = [
  './provider-schedule-desktop-reference.css?v=7',
